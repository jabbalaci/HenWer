...
class SiteSelector(wx.Dialog):
    def __init__(self, parent, title):
        ...
        self.site_combo = wx.ComboBox(
            self, 0, choices=get_choice("./backend"), style=wx.CB_READONLY
        )
    ...
    def on_ok(self, event):
        ...
        self.parent.save_dir_relative = self.manga.get_relative_save_dir(
            self.site_combo.GetValue(), self.manga_combo.GetValue()
        )
